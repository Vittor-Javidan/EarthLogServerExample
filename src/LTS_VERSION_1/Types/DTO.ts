...
export type ProjectSettings = {
  ...
  lts_version?: number                                                                              // The lts version of the project. App uses this to decide if the project should be display or not during project download, according to the user selected lts version. If undefined, the app will consider the project a project from lts version 1.
